...
```{r}
yardstick::metrics(results_train, truth = mpg, estimate = lreg)
```

```{r}
yardstick::metrics(results_train, truth = mpg, estimate = rfor)
```
...
```{r}
yardstick::metrics(results_test, truth = mpg, estimate = lreg)
```
